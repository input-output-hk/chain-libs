...
use crate::{
    fragment::Fragment,
    ledger::{check::TxVerifyError, Entry, Error::{TransactionMalformed,UtxoError}, Ledger},
    testing::{
        arbitrary::{
...
#[test]
pub fn account_spending_counter_max_transaction_with_all_funds() {

}


#[test]
pub fn account_spending_counter_max_transaction_with_partial_funds() {
